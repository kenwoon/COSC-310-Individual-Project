...
public class InventorySystemMain
{
    ...
    public static void main(String[] args)
    {
        ...
        fileDialog.setFileFilter(new FileFilter()
        {
            ...
            {      
                // show all directories and *.csv files in the file picker
            ...
            {        
                // show the description for csv files
    ...
    public static void edit()
    {
        ...
        {       
            ...
            {   
                // check if input was validated and a valid product was returned
    ...
    public static void order()
    {
        ...
        if (dialog.products != null)
        {
            ...
            {     
                // add an order for each item in dialog.products
                int quantity = dialog.products.get(id);
                if (quantity > 0) 
                {     
                    // decrease revenue and place the order
    ...
    public static void transaction()
    {
        ...
        if (dialog.products != null)
        {
            for (int id : dialog.products.keySet())
            {
                ...
                if (quantity > 0)
                {     
                    // increase revenue and decrease the inventory
